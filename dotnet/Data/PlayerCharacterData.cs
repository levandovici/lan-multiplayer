...
namespace Michitai.Lan.Data
{
    ...
    public sealed class PlayerCharacterData : IJsonStorage
    {
        ...
        /// <summary>
        /// Gets or sets the JSON string representation of the player character data.
        /// </summary>
        public string Json
    {
        get
        ...
        /// <summary>
        /// Initializes a new instance of PlayerCharacterData with an empty JSON string.
        /// </summary>
        public PlayerCharacterData()
    {
        ...
        /// <summary>
        /// Initializes a new instance of PlayerCharacterData with the specified JSON string.
        /// </summary>
